...
Current phase: scoped dossier published; Claim 1 toy only
...
Dossier: CLAIM_EVIDENCE.md, SOURCE_AUDIT.md, ENVIRONMENT.md, REPORT.md, claims.json, EVIDENCE_MANIFEST.json, and verify_final.py
